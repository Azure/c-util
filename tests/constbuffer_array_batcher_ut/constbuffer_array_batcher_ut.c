...
/* Tests_SRS_CONSTBUFFER_ARRAY_BATCHER_01_004: [ constbuffer_array_batcher_batch shall allocate memory for the header buffer (enough to hold the entire batch header: (count + 1) uint32_t values) + 1 byte for the version. ]*/
/* Tests_SRS_CONSTBUFFER_ARRAY_BATCHER_01_027: [ The version (1) shall be written as the first byte of the header. ]*/
/* Tests_SRS_CONSTBUFFER_ARRAY_BATCHER_01_005: [ count shall be written as a uint32_t in the header memory per the above layout. ]*/
/* Tests_SRS_CONSTBUFFER_ARRAY_BATCHER_01_006: [ The count of buffers for each array in payloads shall also be written in the header per the above layout. ]*/
...
TEST_FUNCTION(constbuffer_array_batcher_batch_succeeds)
{
    ...
    uint8_t expected_header_memory[] = { 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 };
    umock_c_reset_all_calls();

    STRICT_EXPECTED_CALL(malloc(sizeof(uint32_t) * 2 + 1));
    STRICT_EXPECTED_CALL(write_uint8_t(IGNORED_PTR_ARG, 1));
    ...
    STRICT_EXPECTED_CALL(CONSTBUFFER_CreateWithMoveMemory(IGNORED_PTR_ARG, sizeof(uint32_t) * 2 + 1))
...
TEST_FUNCTION(constbuffer_array_batcher_batch_with_2_empty_arrays_succeeds)
{
    ...
    CONSTBUFFER_HANDLE actual_first_buffer;
    CONSTBUFFER_HANDLE header_buffer;
    uint8_t expected_header_memory[] = { 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
    test_arrays[0] = real_constbuffer_array_create_empty();
    test_arrays[1] = real_constbuffer_array_create_empty();
    umock_c_reset_all_calls();

    STRICT_EXPECTED_CALL(malloc(sizeof(uint32_t) * 3 + 1));
    STRICT_EXPECTED_CALL(write_uint8_t(IGNORED_PTR_ARG, 1));
    ...
    STRICT_EXPECTED_CALL(write_uint32_t(IGNORED_PTR_ARG, 0));
    STRICT_EXPECTED_CALL(malloc(sizeof(CONSTBUFFER_HANDLE) * 1));
    STRICT_EXPECTED_CALL(CONSTBUFFER_CreateWithMoveMemory(IGNORED_PTR_ARG, sizeof(uint32_t) * 3 + 1))
        .ValidateArgumentBuffer(1, expected_header_memory, sizeof(expected_header_memory))
        .CaptureReturn(&header_buffer);
    STRICT_EXPECTED_CALL(constbuffer_array_get_buffer_count(test_arrays[0], IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(constbuffer_array_get_buffer_count(test_arrays[1], IGNORED_PTR_ARG));
...
TEST_FUNCTION(constbuffer_array_batcher_batch_with_an_array_with_1_buffer_succeeds)
{
    ...
    uint8_t expected_header_memory[] = { 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01 };
...
TEST_FUNCTION(constbuffer_array_batcher_batch_with_2_arrays_each_with_1_buffer_succeeds)
{
    ...
    uint8_t expected_header_memory[] = { 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01 };
...
TEST_FUNCTION(constbuffer_array_batcher_batch_with_an_array_with_2_buffers_succeeds)
{
    ...
    uint8_t expected_header_memory[] = { 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02 };
...
TEST_FUNCTION(constbuffer_array_batcher_batch_with_2_arrays_with_1_and_3_buffers_succeeds)
{
    ...
    uint8_t expected_header_memory[] = { 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03 };
...
/* Tests_SRS_CONSTBUFFER_ARRAY_BATCHER_01_010: [ If any error occurs, constbuffer_array_batcher_batch shall fail and return NULL. ]*/
...
/* Tests_SRS_CONSTBUFFER_ARRAY_BATCHER_01_017: [ constbuffer_array_batcher_unbatch shall allocate enough memory to hold the handles for buffer arrays that will be un-batched. ]*/
...
TEST_FUNCTION(constbuffer_array_batcher_unbatch_with_1_payload_with_0_buffers_succeeds)
{
    ...
    CONSTBUFFER_ARRAY_HANDLE* result;
    uint32_t payload_count;
    uint8_t header_buffer_payload[] = { 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 };
    CONSTBUFFER_HANDLE test_buffers[1];
    CONSTBUFFER_ARRAY_HANDLE batch;
    ...
    STRICT_EXPECTED_CALL(read_uint8_t(IGNORED_PTR_ARG, IGNORED_PTR_ARG));
...
TEST_FUNCTION(constbuffer_array_batcher_unbatch_with_2_payload_with_0_buffers_succeeds)
{
    ...
    CONSTBUFFER_ARRAY_HANDLE* result;
    uint32_t payload_count;
    uint8_t header_buffer_payload[] = { 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
    CONSTBUFFER_HANDLE test_buffers[1];
    CONSTBUFFER_ARRAY_HANDLE batch;
    uint32_t buffer_count;
    test_buffers[0] = real_CONSTBUFFER_Create(header_buffer_payload, sizeof(header_buffer_payload));
...
TEST_FUNCTION(constbuffer_array_batcher_unbatch_with_1_payload_with_1_buffers_succeeds)
{
    ...
    CONSTBUFFER_ARRAY_HANDLE* result;
    uint32_t payload_count;
    uint8_t header_buffer_payload[] = { 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01 };
    uint8_t test_buffer_payload[] = { 0x42 };
    CONSTBUFFER_HANDLE test_buffers[2];
...
TEST_FUNCTION(constbuffer_array_batcher_unbatch_with_1_payload_with_2_buffers_succeeds)
{
    ...
    CONSTBUFFER_ARRAY_HANDLE* result;
    uint32_t payload_count;
    uint8_t header_buffer_payload[] = { 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02 };
    uint8_t test_buffer_payload[] = { 0x42 };
...
TEST_FUNCTION(constbuffer_array_batcher_unbatch_with_2_payloads_each_with_different_number_of_buffers_succeeds)
{
    ...
    CONSTBUFFER_ARRAY_HANDLE* result;
    uint32_t payload_count;
    uint8_t header_buffer_payload[] = { 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03 };
    uint8_t test_buffer_payload[] = { 0x42 };
...
/* Tests_SRS_CONSTBUFFER_ARRAY_BATCHER_01_024: [ If the size of the first buffer is less than 5, constbuffer_array_batcher_unbatch shall fail and return NULL. ]*/
TEST_FUNCTION(constbuffer_array_batcher_unbatch_with_header_buffer_size_4_fails)
{
    // arrange
    CONSTBUFFER_ARRAY_HANDLE* result;
    uint32_t payload_count;
    uint8_t header_buffer_payload[] = { 0x01, 0x00, 0x00, 0x00 };
    CONSTBUFFER_HANDLE test_buffers[1];
    CONSTBUFFER_ARRAY_HANDLE batch;
    test_buffers[0] = real_CONSTBUFFER_Create(header_buffer_payload, sizeof(header_buffer_payload));
    batch = real_constbuffer_array_create(test_buffers, 1);
...
static void test_bad_version(uint8_t version)
{
    // arrange
    CONSTBUFFER_ARRAY_HANDLE* result;
    uint32_t payload_count;
    uint8_t header_buffer_payload[] = { version, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 };
    CONSTBUFFER_HANDLE test_buffers[1];
    CONSTBUFFER_ARRAY_HANDLE batch;
    test_buffers[0] = real_CONSTBUFFER_Create(header_buffer_payload, sizeof(header_buffer_payload));
    batch = real_constbuffer_array_create(test_buffers, 1);
    ...
    // assert
    ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
    ASSERT_IS_NULL(result, "expected to fail un-batching for version %" PRIu8, version);
...
/* Tests_SRS_CONSTBUFFER_ARRAY_BATCHER_01_028: [ constbuffer_array_batcher_unbatch shall read the version byte from the header. ]*/
/* Tests_SRS_CONSTBUFFER_ARRAY_BATCHER_01_029: [ If the version is not 1, constbuffer_array_batcher_unbatch shall fail and return NULL. ]*/
TEST_FUNCTION(constbuffer_array_batcher_unbatch_with_bad_version_fails)
{
    uint16_t i;
    for (i = 0; i <= 255; i++)
    {
...
TEST_FUNCTION(constbuffer_array_batcher_unbatch_with_2_payloads_with_1_buffer_but_not_enough_buffers_for_first_payload_fails)
{
    ...
    CONSTBUFFER_ARRAY_HANDLE* result;
    uint32_t payload_count;
    uint8_t header_buffer_payload[] = { 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01 };
    CONSTBUFFER_HANDLE test_buffers[1];
    CONSTBUFFER_ARRAY_HANDLE batch;
    test_buffers[0] = real_CONSTBUFFER_Create(header_buffer_payload, sizeof(header_buffer_payload));
    batch = real_constbuffer_array_create(test_buffers, 1);
...
TEST_FUNCTION(constbuffer_array_batcher_unbatch_with_size_of_header_buffer_not_matching_the_nbumber_of_payloads_fails)
{
    ...
    CONSTBUFFER_ARRAY_HANDLE* result;
    uint32_t payload_count;
    uint8_t header_buffer_payload[] = { 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
    CONSTBUFFER_HANDLE test_buffers[1];
    CONSTBUFFER_ARRAY_HANDLE batch;
    test_buffers[0] = real_CONSTBUFFER_Create(header_buffer_payload, sizeof(header_buffer_payload));
    batch = real_constbuffer_array_create(test_buffers, 1);
...
TEST_FUNCTION(constbuffer_array_batcher_unbatch_with_payload_count_0_fails)
{
    ...
    CONSTBUFFER_ARRAY_HANDLE* result;
    uint32_t payload_count;
    uint8_t header_buffer_payload[] = { 0x01, 0x00, 0x00, 0x00, 0x00 };
    CONSTBUFFER_HANDLE test_buffers[1];
    CONSTBUFFER_ARRAY_HANDLE batch;
    test_buffers[0] = real_CONSTBUFFER_Create(header_buffer_payload, sizeof(header_buffer_payload));
    batch = real_constbuffer_array_create(test_buffers, 1);
