...
static void cleanup_pending_ops(THANDLE(CHANNEL) channel, size_t num_ops)
{
    setup_channel_close_expectations(num_ops);
...
TEST_FUNCTION(channel_open_succeeds)
{
    //arrange
    setup_channel_create_expectations();
    THANDLE(CHANNEL) channel = channel_create(g.g_log_context, g.g_threadpool);
...
/*Tests_SRS_CHANNEL_43_161: [If there are any failures, channel_open shall fail and return a non-zero value.]*/
...
/*Tests_SRS_CHANNEL_43_095: [ abandon_pending_operations shall iterate over the local copy and do the following: ]*/
/*Tests_SRS_CHANNEL_43_096: [ set the result of the operation to CHANNEL_CALLBACK_RESULT_ABANDONED. ]*/
/*Tests_SRS_CHANNEL_43_097: [ call execute_callbacks with the operation as context.]*/
...
TEST_FUNCTION(channel_close_calls_underlying_functions)
{
    ...
    setup_channel_close_expectations(1);
...
/*Tests_SRS_CHANNEL_43_150: [ channel_dispose shall release the reference to the log_context ]*/
/*Tests_SRS_CHANNEL_43_091: [ channel_dispose shall release the reference to THANDLE(THREADPOOL). ]*/
/*Tests_SRS_CHANNEL_43_099: [ channel_dispose shall call srw_lock_destroy. ]*/
/*Tests_SRS_CHANNEL_43_165: [ channel_dispose shall call sm_destroy. ]*/
...
/*Tests_SRS_CHANNEL_43_111: [ channel_pull shall set the result of the created operation to CHANNEL_CALLBACK_RESULT_OK. ]*/
/*Tests_SRS_CHANNEL_43_105: [ channel_pull shall insert the created THANDLE(ASYNC_OP) in the list of pending operations by calling DList_InsertTailList. ]*/
/*Tests_SRS_CHANNEL_43_107: [ channel_pull shall set *out_op_pull to the created THANDLE(ASYNC_OP). ]*/
...
TEST_FUNCTION(channel_pull_on_empty_succeeds)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    THANDLE(ASYNC_OP) pull_op = NULL;
...
/*Tests_SRS_CHANNEL_43_115: [ channel_pull shall call srw_lock_release_exclusive. ]*/
/*Tests_SRS_CHANNEL_43_011: [ channel_pull shall succeeds and return CHANNEL_RESULT_OK. ]*/
TEST_FUNCTION(channel_pull_after_pull_succeeds)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    int32_t pull_context_1 = 0;
    THANDLE(ASYNC_OP) pull_op_1 = NULL;
    CHANNEL_RESULT pull_result_1 = channel_pull(channel, g.g_pull_correlation_id, test_on_data_available_cb_abandoned, &pull_context_1, &pull_op_1);
    ...
    //act
    CHANNEL_RESULT pull_result_2 = channel_pull(channel, g.g_pull_correlation_id, test_on_data_available_cb_abandoned, &pull_context_2, &pull_op_2);
...
TEST_FUNCTION(channel_pull_after_push_succeeds)
{
    ...
    CHANNEL_RESULT push_result_1 = channel_push(channel, g.g_push_correlation_id, rc_ptr, test_on_data_consumed_cb_ok, &push_context, &push_op);
    ...
    //act
    CHANNEL_RESULT pull_result = channel_pull(channel, g.g_pull_correlation_id, test_on_data_available_cb_ok, &pull_context, &pull_op);
...
TEST_FUNCTION(channel_pull_as_first_op_fails_when_underlying_functions_fail)
{
    ...
    for (size_t i = 0; i < umock_c_negative_tests_call_count(); i++)
    {
        if (umock_c_negative_tests_can_call_fail(i))
        {
            ...
            // act
            CHANNEL_RESULT result = channel_pull(channel, g.g_pull_correlation_id, test_on_data_available_cb_abandoned, &pull_context, &pull_op);
...
/*Tests_SRS_CHANNEL_43_023: [If there are any failures, channel_pull shall fail and return CHANNEL_RESULT_ERROR.]*/
TEST_FUNCTION(channel_pull_as_second_op_fails_if_underlying_functions_fail)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    ...
    int32_t push_context = 0;
    THANDLE(ASYNC_OP) push_op = NULL;
    CHANNEL_RESULT push_result = channel_push(channel, g.g_push_correlation_id, data, test_on_data_consumed_cb_ok, &push_context, &push_op);
...
/*Tests_SRS_CHANNEL_43_127: [ channel_push shall set the result of the created operation to CHANNEL_CALLBACK_RESULT_OK. ]*/
/*Tests_SRS_CHANNEL_43_121: [ channel_push shall insert the created THANDLE(ASYNC_OP) in the list of pending operations by calling DList_InsertTailList. ]*/
/*Tests_SRS_CHANNEL_43_123: [ channel_push shall set *out_op_push to the created THANDLE(ASYNC_OP). ]*/
/*Tests_SRS_CHANNEL_43_131: [ channel_push shall call srw_lock_release_exclusive. ]*/
/*Tests_SRS_CHANNEL_43_132: [ channel_push shall succeed and return CHANNEL_RESULT_OK. ]*/
TEST_FUNCTION(channel_push_on_empty_succeeds)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    THANDLE(RC_PTR) data = rc_ptr_create_with_move_pointer(test_data, test_data_dispose, NULL);
    ...
    //act
    CHANNEL_RESULT pull_result = channel_push(channel, g.g_push_correlation_id, data, test_on_data_consumed_cb_abandoned, &push_context, &push_op);
...
/*Tests_SRS_CHANNEL_43_131: [ channel_push shall call srw_lock_release_exclusive. ]*/
/*Tests_SRS_CHANNEL_43_132: [ channel_push shall succeed and return CHANNEL_RESULT_OK. ]*/
TEST_FUNCTION(channel_push_after_push_succeeds)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    ...
    CHANNEL_RESULT push_result_1 = channel_push(channel, g.g_push_correlation_id, data_1, test_on_data_consumed_cb_abandoned, &push_context_1, &push_op_1);
    ASSERT_ARE_EQUAL(CHANNEL_RESULT, CHANNEL_RESULT_OK, push_result_1);
    ...
    //act
    CHANNEL_RESULT push_result_2 = channel_push(channel, g.g_push_correlation_id, data_2, test_on_data_consumed_cb_abandoned, &push_context_2, &push_op_2);
...
/*Tests_SRS_CHANNEL_43_129: [ channel_push shall call threadpool_schedule_work with execute_callbacks as work_function and the obtained operation as work_function_context. ]*/
/*Tests_SRS_CHANNEL_43_130: [ channel_push shall set *out_op_push to the THANDLE(ASYNC_OP) of the obtained operation. ]*/
/*Tests_SRS_CHANNEL_43_131: [ channel_push shall call srw_lock_release_exclusive. ]*/
/*Tests_SRS_CHANNEL_43_132: [ channel_push shall succeed and return CHANNEL_RESULT_OK. ]*/
TEST_FUNCTION(channel_push_after_pull_succeeds)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    int32_t pull_context = 0;
    THANDLE(ASYNC_OP) pull_op = NULL;
    CHANNEL_RESULT pull_result_1 = channel_pull(channel, g.g_pull_correlation_id, test_on_data_available_cb_ok, &pull_context, &pull_op);
    ASSERT_ARE_EQUAL(CHANNEL_RESULT, CHANNEL_RESULT_OK, pull_result_1);
    ASSERT_IS_NOT_NULL(pull_op);
    ...
    //act
    CHANNEL_RESULT push_result = channel_push(channel, g.g_push_correlation_id, rc_ptr, test_on_data_consumed_cb_ok, &push_context, &push_op);
    work_function(work_context);
...
/*Tests_SRS_CHANNEL_43_041: [ If there are any failures, channel_push shall fail and return CHANNEL_RESULT_ERROR. ]*/
TEST_FUNCTION(channel_push_as_first_op_fails_when_underlying_functions_fail)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    THANDLE(ASYNC_OP) push_op = NULL;
    ...
    for (size_t i = 0; i < umock_c_negative_tests_call_count(); i++)
    {
        if (umock_c_negative_tests_can_call_fail(i))
        {
            ...
            // act
            CHANNEL_RESULT result = channel_push(channel, g.g_push_correlation_id, data, test_on_data_consumed_cb_abandoned, &push_context, &push_op);
...
/*Tests_SRS_CHANNEL_43_041: [ If there are any failures, channel_push shall fail and return CHANNEL_RESULT_ERROR. ]*/
TEST_FUNCTION(channel_push_as_second_op_fails_if_underlying_functions_fail)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    THANDLE(ASYNC_OP) pull_op = NULL;
    ...
    //act
    CHANNEL_RESULT result = channel_push(channel, g.g_push_correlation_id, data, test_on_data_consumed_cb_ok, &push_context, &push_op);
...
/*Tests_SRS_CHANNEL_43_154: [ cancel_op shall call sm_exec_begin. ]*/
/*Tests_SRS_CHANNEL_43_134: [ cancel_op shall call srw_lock_acquire_exclusive. ]*/
/*Tests_SRS_CHANNEL_43_135: [ If the operation is in the list of pending operations, cancel_op shall call DList_RemoveEntryList to remove it. ]*/
/*Tests_SRS_CHANNEL_43_139: [ cancel_op shall call srw_lock_release_exclusive. ]*/
/*Tests_SRS_CHANNEL_43_136: [ If the result of the operation is CHANNEL_CALLBACK_RESULT_OK, cancel_op shall set it to CHANNEL_CALLBACK_RESULT_CANCELLED. ]*/
/*Tests_SRS_CHANNEL_43_138: [ If the operation had been found in the list of pending operations, cancel_op shall call threadpool_schedule_work with execute_callbacks as work_function and the operation as work_function_context. ]*/
TEST_FUNCTION(channel_cancel_op_cancels_pull)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    int32_t pull_context = 0;
    THANDLE(ASYNC_OP) pull_op = NULL;
    CHANNEL_RESULT pull_result = channel_pull(channel, g.g_pull_correlation_id, test_on_data_available_cb_cancelled, &pull_context, &pull_op);
    ASSERT_IS_NOT_NULL(pull_op);
    ASSERT_ARE_EQUAL(CHANNEL_RESULT, CHANNEL_RESULT_OK, pull_result);
    umock_c_reset_all_calls();
...
/*Tests_SRS_CHANNEL_43_136: [ If the result of the operation is CHANNEL_CALLBACK_RESULT_OK, cancel_op shall set it to CHANNEL_CALLBACK_RESULT_CANCELLED. ]*/
/*Tests_SRS_CHANNEL_43_139: [ cancel_op shall call srw_lock_release_exclusive. ]*/
/*Tests_SRS_CHANNEL_43_156: [ cancel_op shall call sm_exec_end. ]*/
TEST_FUNCTION(channel_cancel_op_cancels_matched_op)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    THANDLE(RC_PTR) data = rc_ptr_create_with_move_pointer(test_data, test_data_dispose, NULL);
    ...
    CHANNEL_RESULT pull_result = channel_pull(channel, g.g_pull_correlation_id, test_on_data_available_cb_matched_cancelled, &pull_context, &pull_op);
    CHANNEL_RESULT push_result = channel_push(channel, g.g_push_correlation_id, data, test_on_data_consumed_cb_cancelled, &push_context, &push_op);
...
*/
/*Tests_SRS_CHANNEL_43_155: [ If there are any failures, cancel_op shall fail. ]*/
DISABLE_TEST_FUNCTION(channel_cancel_op_fails_to_cancel_abandoned_op)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    int32_t pull_context = 0;
...
/*Tests_SRS_CHANNEL_43_148: [ If channel_op_context is NULL, execute_callbacks shall terminate the process. ]*/
TEST_FUNCTION(channel_execute_callback_fails_with_NULL_context)
{
    //arrange
    THANDLE(CHANNEL) channel = test_create_and_open_channel();
    THANDLE(RC_PTR) data = rc_ptr_create_with_move_pointer(test_data, test_data_dispose, NULL);
