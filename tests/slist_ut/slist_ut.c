...
TEST_DEFINE_ENUM_TYPE(SLIST_IS_EMPTY_RESULT, SLIST_IS_EMPTY_RESULT_VALUES);
...
/* Tests_SRS_SLIST_07_001: [ If list_head is NULL, slist_initialize shall fail and return a non-zero value. ]*/
TEST_FUNCTION(slist_initialize_with_NULL_fails)
{
    // arrange

    // act
    int result = slist_initialize(NULL);

    // assert
    ASSERT_ARE_NOT_EQUAL(int, 0, result);
}

/* Tests_SRS_SLIST_07_002: [ slist_initialize shall initialize the next pointer in list_head points to NULL and return zero on success. ]*/
TEST_FUNCTION(slist_initialize_succeeds)
{
    ...
    // act
    int result = slist_initialize(&head);
...
/* Tests_SRS_SLIST_07_038: [ If list_head is NULL, slist_is_empty shall fail and return INVALID_ARGS. ]*/
TEST_FUNCTION(slist_is_empty_with_NULL_list_fails)
{
    // arrange

    // act
    SLIST_IS_EMPTY_RESULT result = slist_is_empty(NULL);

    // assert
    ASSERT_ARE_EQUAL(SLIST_IS_EMPTY_RESULT, INVALID_ARGS, result);
}

/* Tests_SRS_SLIST_07_003: [ slist_is_empty shall return EMPTY if there is no SINGLYLINKEDLIST_ENTRY in this list. ]*/
TEST_FUNCTION(slist_is_empty_with_empty_list_returns_that_list_is_empty)
{
    // arrange
    SINGLYLINKEDLIST_ENTRY head;
    (void)slist_initialize(&head);

    // act
    SLIST_IS_EMPTY_RESULT result = slist_is_empty(&head);

    // assert
    ASSERT_ARE_EQUAL(SLIST_IS_EMPTY_RESULT, EMPTY, result);
}

/* Tests_SRS_SLIST_07_004: [ slist_is_empty shall return NOT_EMPTY if there is one or more entris in the list. ]*/
TEST_FUNCTION(slist_is_empty_with_one_entry_returns_that_list_is_not_empty)
{
    // arrange
    ...
    SINGLYLINKEDLIST_ENTRY head;
    (void)slist_initialize(&head);
    (void)slist_add(&head, &(simp1.link));

    // act
    SLIST_IS_EMPTY_RESULT result = slist_is_empty(&head);

    // assert
    ASSERT_ARE_EQUAL(SLIST_IS_EMPTY_RESULT, NOT_EMPTY, result);
}

/* Tests_SRS_SLIST_07_004: [ slist_is_empty shall return NOT_EMPTY if there is one or more entris in the list. ]*/
TEST_FUNCTION(slist_is_empty_with_multiple_entries_returns_that_list_is_not_empty)
{
    // arrange
    static SIMPLE_ITEM simp1 = { 1, { NULL } };
    ...
    (void)slist_initialize(&head);
    (void)slist_add(&head, &(simp1.link));
    (void)slist_add(&head, &(simp2.link));
    (void)slist_add(&head, &(simp3.link));
...
/* Tests_SRS_SLIST_07_005: [ If list_head is NULL, slist_add shall fail and return a non-zero value. ]*/
TEST_FUNCTION(slist_add_with_head_entry_NULL_fails)
{
    ...
    // act
    int result = slist_add(NULL, &(simp1.link));

    // assert
    ASSERT_ARE_NOT_EQUAL(int, 0, result);
}

/* Tests_SRS_SLIST_07_006: [ If list_entry is NULL, slist_add shall fail and return a non-zero value. ]*/
TEST_FUNCTION(slist_add_with_add_entry_NULL_fails)
{
    ...
    // act
    int result = slist_add(&head, NULL);

    // assert
    ASSERT_ARE_NOT_EQUAL(int, 0, result);
}

/* Tests_SRS_SLIST_07_007: [ slist_add shall add one entry to the tail of the list and return zero on success. ]*/
TEST_FUNCTION(slist_add_with_empty_list_succeeds)
{
    ...
    // act
    int result = slist_add(&head, &(simp1.link));
...
TEST_FUNCTION(slist_add_with_multiple_entries_in_the_list_succeeds)
{
    ...
    SINGLYLINKEDLIST_ENTRY head;
    (void)slist_initialize(&head);
    (void)slist_add_head(&head, &(simp1.link));
    (void)slist_add_head(&head, &(simp2.link));
    (void)slist_add_head(&head, &(simp3.link));

    // act
    int result = slist_add(&head, &(simp4.link));
...
/* Tests_SRS_SLIST_07_008: [ If list_head is NULL, slist_add_head shall fail and return a non-zero value. ]*/
TEST_FUNCTION(slist_add_head_with_head_NULL_fails)
{
    ...
    // act
    int result = slist_add_head(NULL, &(simp1.link));

    // assert
    ASSERT_ARE_NOT_EQUAL(int, 0, result);
}

/* Tests_SRS_SLIST_07_009: [ If list_entry is NULL, slist_add_head shall fail and return a non-zero value. ]*/
TEST_FUNCTION(slist_add_head_with_add_entry_NULL_fails)
{
    ...
    // act
    int result = slist_add_head(&head, NULL);

    // assert
    ASSERT_ARE_NOT_EQUAL(int, 0, result);
}

/* Tests_SRS_SLIST_07_010: [ slist_add_head shall insert list_entry at head and return zero on success. ]*/
TEST_FUNCTION(slist_add_head_with_empty_list_succeeds)
{
    ...
    // act
    int result = slist_add_head(&head, &(simp1.link));
...
TEST_FUNCTION(slist_add_head_with_multiple_entries_in_the_list_succeeds)
{
    ...
    // act
    int result = slist_add_head(&head, &(simp4.link));
...
TEST_FUNCTION(slist_remove_with_multiple_entries_in_list_remove_tail_succeeds)
{
    ...
    (void)slist_add(&head, &(simp2.link));
    (void)slist_add(&head, &(simp3.link));
    (void)slist_add(&head, &(simp4.link));
...
/* Tests_SRS_SLIST_07_039: [ If the item is not found, slist_find shall return NULL. ]*/
TEST_FUNCTION(slist_find_on_a_list_with_100_items_where_none_matches_returns_NULL)
{
    // arrange
    ...
    SIMPLE_ITEM arr[100];
    SINGLYLINKEDLIST_ENTRY entry[100];
    for (int i = 0; i < 100; i++)
    {   
        arr[i].index = (unsigned char)i;      
        entry[i].next = NULL;
        arr[i].link = entry[i];
        (void)slist_add(&head, &(arr[i].link));
    }
