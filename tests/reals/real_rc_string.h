...
#define REGISTER_RC_STRING_GLOBAL_MOCK_HOOKS() \
    ...
    REGISTER_GLOBAL_MOCK_HOOK(THANDLE_INC_REF(RC_STRING), THANDLE_INC_REF(real_RC_STRING)) \
    REGISTER_GLOBAL_MOCK_HOOK(THANDLE_DEC_REF(RC_STRING), THANDLE_DEC_REF(real_RC_STRING)) \
