...
THANDLE_TYPE_DECLARE(TARRAY_TYPEDEF_NAME(uint32_t), TARRAY_TYPEDEF_NAME(uint32_t));
THANDLE_TYPE_DEFINE(TARRAY_TYPEDEF_NAME(uint32_t), TARRAY_TYPEDEF_NAME(uint32_t));
...
THANDLE_TYPE_DECLARE(A_TEST, A_TEST);
THANDLE_TYPE_DEFINE(A_TEST, A_TEST);

TARRAY_DEFINE_STRUCT_TYPE(THANDLE(A_TEST))
THANDLE_TYPE_DECLARE(TARRAY_TYPEDEF_NAME(THANDLE(A_TEST)), TARRAY_TYPEDEF_NAME(THANDLE(A_TEST)));
THANDLE_TYPE_DEFINE(TARRAY_TYPEDEF_NAME(THANDLE(A_TEST)), TARRAY_TYPEDEF_NAME(THANDLE(A_TEST)));
