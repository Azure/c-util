...
LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE ll_async_op_module_fake_cancel_create(EXECUTION_ENGINE_HANDLE execution_engine)
{
...
void ll_async_op_module_fake_cancel_destroy(LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE handle)
{
    if (handle == NULL)
    {
...
int ll_async_op_module_fake_cancel_open(LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE handle)
{
    int result;
    if (handle == NULL)
    {
...
void ll_async_op_module_fake_cancel_close(LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE handle)
{
    if (handle == NULL)
    {
        LogError("Invalid argument LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE handle=%p", handle);
...
int ll_async_op_module_fake_cancel_execute_async(LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE handle, uint32_t complete_in_ms, THANDLE(ASYNC_OP)* async_op_out, COMMON_ASYNC_OP_MODULE_EXECUTE_CALLBACK callback, void* context)
{
    int result;
    if (
        handle == NULL ||
...
void ll_async_op_module_fake_cancel_next_call_completes_synchronously(LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE handle, bool is_synchronous)
{
    if (handle == NULL)
    {
...
void ll_async_op_module_fake_cancel_set_report_retry_result_count(LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE handle, uint32_t retry_result_count)
{
    if (handle == NULL)
    {
...
void ll_async_op_module_fake_cancel_set_next_async_result(LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE handle, COMMON_ASYNC_OP_MODULE_RESULT next_result)
{
    if (handle == NULL)
    {
...
int ll_async_op_module_fake_cancel_add_result_settings_to_queue(LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE handle, bool is_synchronous, COMMON_ASYNC_OP_MODULE_RESULT next_result)
{
    int result;
...
COMMON_ASYNC_OP_MODULE_INTERFACE ll_async_op_module_fake_cancel_get_interface(LL_ASYNC_OP_MODULE_FAKE_CANCEL_HANDLE handle)
{
