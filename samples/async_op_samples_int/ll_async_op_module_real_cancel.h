...
MOCKABLE_FUNCTION(, int, ll_async_op_module_real_cancel_add_result_settings_to_queue, LL_ASYNC_OP_MODULE_REAL_CANCEL_HANDLE, handle, bool, is_synchronous, COMMON_ASYNC_OP_MODULE_RESULT, next_result);


// Helper to provide a common interface for testing
MOCKABLE_FUNCTION(, COMMON_ASYNC_OP_MODULE_INTERFACE, ll_async_op_module_real_cancel_get_interface, LL_ASYNC_OP_MODULE_REAL_CANCEL_HANDLE, handle);
