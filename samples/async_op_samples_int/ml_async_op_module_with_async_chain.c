...
static void ml_async_op_module_with_async_chain_on_ll_complete_with_fake_cancel_step_1(void* context, COMMON_ASYNC_OP_MODULE_RESULT result)
{
    ...
    else
    {
        ...
        if (!is_canceled)
        {
            ...
            if (ll_async_op_module_fake_cancel_execute_async(async_op_context->handle->ll_fake_cancel, async_op_context->complete_in_ms, &ll_async_op, ml_async_op_module_with_async_chain_on_ll_complete_with_fake_cancel_step_2, context) != 0)
            {
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (ll_async_op_module_fake_cancel_execute_async(handle->ll_fake_cancel, complete_in_ms, &ll_async_op, ml_async_op_module_with_async_chain_on_ll_complete_with_fake_cancel_step_1, (void*)async_op_ref_for_callback) != 0)
                {
                    LogError("ll_async_op_module_fake_cancel_execute_async failed");
                    result = MU_FAILURE;
                }
...
static void ml_async_op_module_with_async_chain_on_ll_complete_with_real_cancel_step_1(void* context, COMMON_ASYNC_OP_MODULE_RESULT result)
{
    ...
    else
    {
        ...
        if (!is_canceled)
        {
            ...
            // 5. Call the next step in the chain
            if (ll_async_op_module_real_cancel_execute_async(async_op_context->handle->ll_real_cancel, async_op_context->complete_in_ms, &ll_async_op, ml_async_op_module_with_async_chain_on_ll_complete_with_real_cancel_step_2, context) != 0)
            {
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                // 7. Start the first step of the async work, passing the async_op_ref_for_callback as the context
                if (ll_async_op_module_real_cancel_execute_async(handle->ll_real_cancel, complete_in_ms, &ll_async_op, ml_async_op_module_with_async_chain_on_ll_complete_with_real_cancel_step_1, (void*)async_op_ref_for_callback) != 0)
                {
                    LogError("ll_async_op_module_real_cancel_execute_async failed");
                    result = MU_FAILURE;
                }
