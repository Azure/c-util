`constbuffer_array_batcher_nv` requirements
================
...
**SRS_CONSTBUFFER_ARRAY_BATCHER_NV_02_001: [** If `count` is greater than `UINT32_MAX / sizeof(uint32_t) - 1` then `constbuffer_array_batcher_nv_batch` shall fail and return `NULL`. **]**
