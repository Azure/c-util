...
MOCKABLE_FUNCTION(, int32_t, interlocked_add, volatile_atomic int32_t*, addend, int32_t, value);
```
**SRS_INTERLOCKED_LINUX_43_001: [** `interlocked_add` shall call `atomic_fetch_add` . **]**
...
MOCKABLE_FUNCTION(, int64_t, interlocked_add_64, volatile_atomic int64_t*, addend, int64_t, value);
```
**SRS_INTERLOCKED_LINUX_43_064: [** `interlocked_add_64` shall call `atomic_fetch_add` . **]**
...
MOCKABLE_FUNCTION(, int32_t, interlocked_and, volatile_atomic int32_t*, destination, int32_t, value);
```
**SRS_INTERLOCKED_LINUX_43_003: [** `interlocked_and` shall call `atomic_fetch_and` . **]**
...
MOCKABLE_FUNCTION(, int16_t, interlocked_and_16, volatile_atomic int16_t*, destination, int16_t, value);
```
**SRS_INTERLOCKED_LINUX_43_005: [** `interlocked_and_16` shall call `atomic_fetch_and` . **]**
...
MOCKABLE_FUNCTION(, int64_t, interlocked_and_64, volatile_atomic int64_t*, destination, int64_t, value);
```
**SRS_INTERLOCKED_LINUX_43_007: [** `interlocked_and_64` shall call `atomic_fetch_and` . **]**
...
MOCKABLE_FUNCTION(, int8_t, interlocked_and_8, volatile_atomic int8_t*, destination, int8_t, value);
```
**SRS_INTERLOCKED_LINUX_43_009: [** `interlocked_and_8` shall call `atomic_fetch_and` . **]**
...
MOCKABLE_FUNCTION(, int32_t, interlocked_compare_exchange, volatile_atomic int32_t*, destination, int32_t, exchange, int32_t, comperand);
```
**SRS_INTERLOCKED_LINUX_43_011: [** `interlocked_compare_exchange` shall call `atomic_compare_exchange_strong` . **]**
...
MOCKABLE_FUNCTION(, int16_t, interlocked_compare_exchange_16, volatile_atomic int16_t*, destination, int16_t, exchange, int16_t, comperand);
```
**SRS_INTERLOCKED_LINUX_43_015: [** `interlocked_compare_exchange_16` shall call `atomic_compare_exchange_strong` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_017: [** `interlocked_compare_exchange_64` shall call `atomic_compare_exchange_strong` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_019: [** `interlocked_compare_exchange_pointer` shall call `atomic_compare_exchange_strong` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_021: [** `interlocked_decrement` shall call `atomic_fetch_sub` . **]**
...
MOCKABLE_FUNCTION(, int16_t, interlocked_decrement_16, volatile_atomic int16_t*, addend);
```
**SRS_INTERLOCKED_LINUX_43_023: [** `interlocked_decrement_16` shall call `atomic_fetch_sub` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_025: [** `interlocked_decrement_64` shall call `atomic_fetch_sub` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_027: [** `interlocked_exchange` shall call `atomic_exchange` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_029: [** `interlocked_exchange_16` shall call `atomic_exchange` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_031: [** `interlocked_exchange_64` shall call `atomic_exchange` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_033: [** `interlocked_exchange_8` shall call `atomic_exchange` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_035: [** `interlocked_exchange_add` shall call `atomic_fetch_add` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_037: [** `interlocked_exchange_add_64` shall call `atomic_fetch_add` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_039: [** `interlocked_exchange_pointer` shall call `atomic_exchange` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_041: [** `interlocked_increment` shall call `atomic_fetch_add` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_043: [** `interlocked_increment_16` shall call `atomic_fetch_add` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_045: [** `interlocked_increment_64` shall call `atomic_fetch_add` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_047: [** `interlocked_or` shall call `atomic_fetch_or` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_049: [** `interlocked_or_16` shall call `atomic_fetch_or` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_051: [** `interlocked_or_64` shall call `atomic_fetch_or` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_053: [** `interlocked_or_8` shall call `atomic_fetch_or` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_055: [** `interlocked_xor` shall call `atomic_fetch_xor` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_057: [** `interlocked_xor_16` shall call `atomic_fetch_xor` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_059: [** `interlocked_xor_64` shall call `atomic_fetch_xor` . **]**
...
```
**SRS_INTERLOCKED_LINUX_43_061: [** `interlocked_xor_8` shall call `atomic_fetch_xor` . **]**
