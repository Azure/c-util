...
#define FLAGS_TO_STRING_DECLARE_FUNCTION(X) MOCKABLE_FUNCTION(, char*, FLAGS_TO_STRING(X), uint32_t, value)
...
{                                                                                                                                                                                                               \
    ...
    bool firstFlag = true;                                                                                                                                                                                      \
                                                                                                                                                                                                                \
    /*Codes_SRS_TLS_SECURITY_SCHANNEL_HELPER_02_038: [ For each of the known flags FLAG_to_string shall define 2 variables: separator_N and value_N both of them of type const char*. N is a decreasing number (all the way to 1) for every of the predefined flags. ]*/ \
    /*Codes_SRS_TLBS_SECURITY_SCHANNEL_HELPER_02_039: [ separator_N shall contain either "" (empty string) or " | ", depending on whether this is the first known flag or not. ]*/                               \
    /*Codes_SRS_TLS_SECURITY_SCHANNEL_HELPER_02_040: [ If the flag is set then value_N shall contain the stringification of the flag. ]*/                                                                       \
    /*Codes_SRS_TLS_SECURITY_SCHANNEL_HELPER_02_041: [ If the flag is not set then value_N shall contain "" (empty string). ]*/                                                                                 \
    /*Codes_SRS_TLS_SECURITY_SCHANNEL_HELPER_02_042: [ FLAG_to_string shall reset (set to 0) all the used known flags in argument. ]*/                                                                          \
    MU_FOR_EACH_2_COUNTED(MAKE_SEPARATOR_AND_VALUE, __VA_ARGS__);                                                                                                                                               \
                                                                                                                                                                                                                \
    if (argument != 0)                                                                                                                                                                                          \
    {                                                                                                                                                                                                           \
                                                                                                                                                                                                                \
        /*Codes_SRS_TLS_SECURITY_SCHANNEL_HELPER_02_043: [ If following the reset of the known flags, there are still bits set in argument, then FLAG_to_string shall prepare a string using the format "%s%s%s%s%s%s%s%s%s%s%sUNKNOWN_FLAG(%#.8" PRIx32 ")", where each pair of %s%s corresponds to a pair of separator_N/value_N; the last %s corresponds to either "" or " | " depeding on argument not containing or containing any known flags; %PRIx32 corresponds to the remaining (unknown) flags; ]*/ \
        ...
        if (result == NULL)                                                                                                                                                                                     \
        {                                                                                                                                                                                                       \
            /*Codes_SRS_TLS_SECURITY_SCHANNEL_HELPER_02_045: [ If there are any failures then FLAG_to_string shall fails and return NULL. ]*/                                                                   \
        ...
        {                                                                                                                                                                                                       \
            /*Codes_SRS_TLS_SECURITY_SCHANNEL_HELPER_02_037: [ FLAG_to_string shall succeed and return a non-NULL string. ]*/                                                                                   \
            /*return as is*/                                                                                                                                                                                    \
        }                                                                                                                                                                                                       \
                                                                                                                                                                                                                \
    }                                                                                                                                                                                                           \
    ...
    {                                                                                                                                                                                                           \
        /*Codes_SRS_TLS_SECURITY_SCHANNEL_HELPER_02_044: [ If following the reset of the known flags, there are no bits set in argument, then FLAG_to_string shall prepare a string using the format "%s%s%s%s%s%s%s%s%s%s", where each pair of %s%s corresponds to a pair of separator_N/value_N; ]*/ \
