...
#define TQUEUE_GET_COUNT_DECLARE(T) TQUEUE_LL_GET_COUNT_DECLARE(T, T)
...
#define TQUEUE_GET_COUNT_DEFINE(T) TQUEUE_LL_GET_COUNT_DEFINE(T, T)
...
#define TQUEUE_GET_COUNT(C) TQUEUE_LL_GET_COUNT(C)
