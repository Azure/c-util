...
static void cancel_channel_op(void* context)
{
    ...
    /*Codes_SRS_CHANNEL_INTERNAL_43_134: [ cancel_channel_op shall call srw_lock_acquire_exclusive. ]*/
    srw_lock_acquire_exclusive(channel_internal_ptr->lock);
    {
        ...
        {
            /*Codes_SRS_CHANNEL_INTERNAL_43_137: [ cancel_channel_op shall call DList_RemoveEntryList to remove the operation from the list of pending operations. ]*/
            (void)DList_RemoveEntryList(&channel_op->anchor);

            /*Codes_SRS_CHANNEL_INTERNAL_43_136: [ cancel_channel_op shall set the result of the operation to CHANNEL_CALLBACK_RESULT_CANCELLED. ]*/
            channel_op->result = CHANNEL_CALLBACK_RESULT_CANCELLED;

            /*Codes_SRS_CHANNEL_INTERNAL_43_138: [ cancel_channel_op shall call threadpool_schedule_work with execute_callbacks as work_function and the operation as work_function_context. ]*/
            if (threadpool_schedule_work(channel_internal_ptr->threadpool, execute_callbacks, channel_op) != 0)
            {
                LogError("Failure in threadpool_schedule_work(execute_callbacks, channel_op)");
            }
        }
        /*Codes_SRS_CHANNEL_INTERNAL_43_146: [ If theoperation is not in the list of pending operations and the result of the operation is CHANNEL_CALLBACK_RESULT_OK, cancel_channel_op shall set the result of the operation to CHANNEL_CALLBACK_RESULT_CANCELLED. ]*/
        else if (channel_op->result == CHANNEL_CALLBACK_RESULT_OK)
        {
            channel_op->result = CHANNEL_CALLBACK_RESULT_CANCELLED;
        }
    }
    /*Codes_SRS_CHANNEL_INTERNAL_43_139: [ cancel_channel_op shall call srw_lock_release_exclusive. ]*/
    srw_lock_release_exclusive(channel_internal_ptr->lock);
}
...
{
    int result;
    /*Codes_SRS_CHANNEL_INTERNAL_43_103: [ channel_pull shall create a THANDLE(ASYNC_OP) by calling async_op_create with cancel_channel_op as cancel. ]*/
    /*Codes_SRS_CHANNEL_INTERNAL_43_119: [ channel_push shall create a THANDLE(ASYNC_OP) by calling async_op_create with cancel_channel_op as cancel. ]*/
    ...
    else
    {
        ...
        /*Codes_SRS_CHANNEL_INTERNAL_43_104: [ channel_pull shall store the pull_callback and pull_context in the THANDLE(ASYNC_OP). ]*/
        channel_op->pull_callback = pull_callback;
        channel_op->pull_context = pull_context;


        /*Codes_SRS_CHANNEL_INTERNAL_43_120: [ channel_push shall store the push_callback, push_context and data in the THANDLE(ASYNC_OP). ]*/
        ...
        /*Codes_SRS_CHANNEL_INTERNAL_43_111: [ channel_pull shall set the result of the created operation to CHANNEL_CALLBACK_RESULT_OK. ]*/
        /*Codes_SRS_CHANNEL_INTERNAL_43_127: [ channel_push shall set the result of the created operation to CHANNEL_CALLBACK_RESULT_OK. ]*/
        channel_op->result = CHANNEL_CALLBACK_RESULT_OK;

        /*Codes_SRS_CHANNEL_INTERNAL_43_105: [ channel_pull shall insert the created THANDLE(ASYNC_OP) in the list of pending operations by calling DList_InsertTailList. ]*/
        /*Codes_SRS_CHANNEL_INTERNAL_43_121: [ channel_push shall insert the created THANDLE(ASYNC_OP) in the list of pending operations by calling DList_InsertTailList. ]*/
        DList_InsertTailList(&channel_internal->op_list, &channel_op->anchor);

        /*Codes_SRS_CHANNEL_INTERNAL_43_107: [ channel_pull shall set *out_op_pull to the created THANDLE(ASYNC_OP). ]*/
        /*Codes_SRS_CHANNEL_INTERNAL_43_123: [ channel_push shall set *out_op_push to the created THANDLE(ASYNC_OP). ]*/
...
static int dequeue_operation(CHANNEL_INTERNAL* channel_internal, THANDLE(ASYNC_OP)* out_op, PULL_CALLBACK pull_callback, void* pull_context, PUSH_CALLBACK push_callback, void* push_context, THANDLE(RC_PTR) data)
{
    ...
    /*Codes_SRS_CHANNEL_INTERNAL_43_109: [ channel_pull shall call DList_RemoveHeadList on the list of pending operations to obtain the operation. ]*/
    /*Codes_SRS_CHANNEL_INTERNAL_43_125: [ channel_push shall call DList_RemoveHeadList on the list of pending operations to obtain the operation. ]*/
    ...
    if (pull_callback)
    {
        /*Codes_SRS_CHANNEL_INTERNAL_43_112: [ channel_pull shall store the pull_callback and pull_context in the obtained operation. ]*/
        channel_op->pull_callback = pull_callback;
        channel_op->pull_context = pull_context;
    }
    else if (push_callback)
    {
        /*Codes_SRS_CHANNEL_INTERNAL_43_128: [ channel_push shall store the push_callback, push_context and data in the obtained operation. ]*/
        channel_op->push_callback = push_callback;
        channel_op->push_context = push_context;
        THANDLE_ASSIGN(RC_PTR)(&channel_op->data, data);
    }

    /*Codes_SRS_CHANNEL_INTERNAL_43_113: [ channel_pull shall call threadpool_schedule_work with execute_callbacks as work_function and the obtained operation as work_function_context. ]*/
    /*Codes_SRS_CHANNEL_INTERNAL_43_129: [ channel_push shall call threadpool_schedule_work with execute_callbacks as work_function and the obtained operation as work_function_context. ]*/
...
IMPLEMENT_MOCKABLE_FUNCTION(, CHANNEL_RESULT, channel_internal_pull, THANDLE(CHANNEL_INTERNAL), channel_internal, PULL_CALLBACK, pull_callback, void*, pull_context, THANDLE(ASYNC_OP)*, out_op_pull)
{
    ...
    /*Codes_SRS_CHANNEL_INTERNAL_43_007: [ If channel is NULL, channel_pull shall fail and return CHANNEL_RESULT_INVALID_ARGS. ]*/
    /*Codes_SRS_CHANNEL_INTERNAL_43_008: [ If pull_callback is NULL, channel_pull shall fail and return CHANNEL_RESULT_INVALID_ARGS. ]*/
    /*Codes_SRS_CHANNEL_INTERNAL_43_009: [ If out_op_pull is NULL, channel_pull shall fail and return CHANNEL_RESULT_INVALID_ARGS. ]*/
    if (channel_internal == NULL ||
        pull_callback == NULL ||
        out_op_pull == NULL
        )
    ...
    else
    {
        ...
        /*Codes_SRS_CHANNEL_INTERNAL_43_010: [ channel_pull shall call srw_lock_acquire_exclusive. ]*/
        srw_lock_acquire_exclusive(channel_internal_ptr->lock);
        {
                ...
                )
            {
                ...
                {
                    /*Codes_SRS_CHANNEL_INTERNAL_43_023: [ If there are any failures, channel_pull shall fail and return CHANNEL_RESULT_ERROR. ]*/
                ...
                {
                    /*Codes_SRS_CHANNEL_INTERNAL_43_011: [ channel_pull shall succeeds and return CHANNEL_RESULT_OK. ]*/
        ...
        /*Codes_SRS_CHANNEL_INTERNAL_43_115: [ channel_pull shall call srw_lock_release_exclusive. ]*/
        srw_lock_release_exclusive(channel_internal_ptr->lock);
    }
    return result;
}
...
IMPLEMENT_MOCKABLE_FUNCTION(, CHANNEL_RESULT, channel_internal_push, THANDLE(CHANNEL_INTERNAL), channel_internal, THANDLE(RC_PTR), data, PUSH_CALLBACK, push_callback, void*, push_context, THANDLE(ASYNC_OP)*, out_op_push)
{
    ...
    /*Codes_SRS_CHANNEL_INTERNAL_43_024: [ If channel is NULL, channel_push shall fail and return CHANNEL_RESULT_INVALID_ARGS. ]*/
    /*Codes_SRS_CHANNEL_INTERNAL_43_025: [ If push_callback is NULL, channel_push shall fail and return CHANNEL_RESULT_INVALID_ARGS. ]*/
    /*Codes_SRS_CHANNEL_INTERNAL_43_026: [ If out_op_push is NULL, channel_push shall fail and return CHANNEL_RESULT_INVALID_ARGS. ]*/
    if (channel_internal == NULL ||
        push_callback == NULL ||
        out_op_push == NULL
        )
    {
        LogError("Invalid arguments: THANDLE(CHANNEL) channel=%p, THANDLE(RC_PTR) data = %p, PUSH_CALLBACK push_callback=%p, void* push_context=%p, THANDLE(ASYNC_OP)* out_op_push=%p", channel_internal, data, push_callback, push_context, out_op_push);
        result = CHANNEL_RESULT_INVALID_ARGS;
    }
    else
    {
        ...
        /*Codes_SRS_CHANNEL_INTERNAL_43_116: [ channel_push shall call srw_lock_acquire_exclusive. ]*/
        srw_lock_acquire_exclusive(channel_internal_ptr->lock);
        {
                ...
                )
            {
                ...
                {
                    /*Codes_SRS_CHANNEL_INTERNAL_43_041: [ If there are any failures, channel_push shall fail and return CHANNEL_RESULT_ERROR. ]*/
                    LogError("Failure in enqueue_operation(channel_internal_ptr, out_op_push, NULL, NULL, push_callback, push_context, data)");
                    result = CHANNEL_RESULT_ERROR;
                }
                else
                {
                    /*Codes_SRS_CHANNEL_INTERNAL_43_132: [ channel_push shall succeed and return CHANNEL_RESULT_OK. ]*/
                    result = CHANNEL_RESULT_OK;
                }
            }
        ...
        /*Codes_SRS_CHANNEL_INTERNAL_43_131: [ channel_push shall call srw_lock_release_exclusive. ]*/
        srw_lock_release_exclusive(channel_internal_ptr->lock);
    }
    return result;
}
